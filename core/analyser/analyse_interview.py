...
def analyse_with_prompt(prompt: str) -> str:
    """Analyze content using a custom prompt."""
...
def analyse_interview(context: InterviewerContext) -> str:
    """Legacy function for interview analysis."""
    ...
    return analyse_with_prompt(final_instruction)